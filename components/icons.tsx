...
export const ArrowPathIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0 3.181 3.183a8.25 8.25 0 0 0 11.667 0l3.181-3.183m-11.667-11.667-3.181 3.183a8.25 8.25 0 0 0 0 11.667l3.181 3.183" />
    </svg>
);

export const CogIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6h3m-3 12h3m-11.25-6h19.5M5.25 6h.008v.008H5.25V6Zm-.008 6h.008v.008H5.25v-.008Zm0 6h.008v.008H5.25v-.008Zm13.5-12h.008v.008H18.75V6Zm-.008 6h.008v.008H18.75v-.008Zm0 6h.008v.008H18.75v-.008Z" />
    </svg>
);
...
export const ClipboardDocumentListIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75 2.25 2.25 0 0 0-.1-.664m-5.8 0A2.251 2.251 0 0 1 12 2.25c.27 0 .535.076.768.215m5.435 2.332A2.249 2.249 0 0 0 12 4.5c-.27 0-.535-.076-.768-.215m5.435 2.332l-1.285 5.14a2.25 2.25 0 0 1-2.172 1.594h-1.028a2.25 2.25 0 0 1-2.172-1.594l-1.285-5.14m5.435 2.332A2.249 2.249 0 0 0 12 4.5c-.27 0-.535-.076-.768-.215" />
    </svg>
);
